...
MENU_TREE = [
...

    {
        ...
        "roles": ["ADMIN", "PDL", "COE_LEADER", "TEAM_LEAD", "EMPLOYEE"],
        "submenus": [
            {"key": "monthly", "title": "Monthly Allocation", "url": reverse_lazy("projects:monthly_allocations"), "roles": ["PDL","ADMIN"]},
    ...
    },
    {
        ...
        "submenus": [
            ...
            {"key": "holidays", "title": "Annual Holidays", "url": reverse_lazy("settings:settings_holidays"), "roles": ["PDL","ADMIN"]},
